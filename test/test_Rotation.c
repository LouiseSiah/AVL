 ...
 *              50(0)
 */
void test_leftRotate_given_balanceFactor_of_rightChild_is_1_should_rotate_as_expect(void)
{
  setNode(0, 50, NULL, NULL, &node50);
  setNode(0, 40, NULL, &node50, &node40);
  setNode(0, 20, NULL, &node40, &node20);
 ...
 *
 */
void test_leftRotate_given_balanceFactor_of_rightChild_is_0_should_rotate_as_expect(void)
{
  setNode(0, 40, NULL, NULL, &node40);
  setNode(0, 90, NULL, NULL, &node90);
  setNode(0, 60, &node40, &node90, &node60);
  setNode(0, 20, NULL, &node60, &node20);

  Node *tree = leftRotate(&node20);

  TEST_ASSERT_EQUAL_TREE(0, 60, &node20, &node90, tree);
  TEST_ASSERT_EQUAL_TREE(0, 20, NULL, &node40, tree->left);
 ...
 *        20(0)
 */
void test_rightRotate_given_balanceFactor_of_leftChild_is_minus1_should_rotate_as_expect(void)
{
  setNode(0, 20, NULL, NULL, &node20);
  setNode(0, 40, &node20, NULL, &node40);
  setNode(0, 50, &node40, NULL, &node50);
 ...
 *  10(0) 40(0)                              40(0)
 */
void test_rightRotate_given_balanceFactor_of_leftChild_is_0_should_rotate_as_expect(void)
{
  setNode(0, 10, NULL, NULL, &node10);
  setNode(0, 40, NULL, NULL, &node40);
  setNode(0, 30, &node10, &node40, &node30);
  setNode(0, 70, &node30, NULL, &node70);

  Node *tree = rightRotate(&node70);

  TEST_ASSERT_EQUAL_TREE(0, 30, &node10, &node70, tree);
  TEST_ASSERT_EQUAL_TREE(0, 10, NULL, NULL, tree->left);
  TEST_ASSERT_EQUAL_TREE(0, 70, &node40, NULL, tree->right);
